...
import logo from './logoachs.png'; // Tell Webpack this JS file uses this image
...
```css
.Logo {
  background-image: url(./logoachs.png);
}
```
...
render() {
  ...
  return <img src={process.env.PUBLIC_URL + '/img/logoachs.png'} />;
}
```
